...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>กลุ่ม(งาน) ในหน่วยงาน</strong></font></td></tr>";
echo "</table>";
}
...
echo "<Center>";
echo "<Font color='#006666' Size=3><B>เพิ่ม กลุ่ม(งาน) ในหน่วยงาน</Font>";
echo "</Cener>";
echo "<Br><Br>";
echo "<Table width='50%' Border='0' Bgcolor='#Fcf9d8'>";
echo "<Tr><Td align='right' width='50%' >รหัสกลุ่ม&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left' width='50%' ><Input Type='Text' Name='workgroup' Size='5' ></Td></Tr>";
echo "<Tr><Td align='right'>ชื่อกลุ่ม&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='workgroup_desc' Size='20'></Td></Tr>";
...
echo "<Tr><Td align='right'>รหัสกลุ่ม&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='workgroup' Size='5' value='$ref_result[workgroup]'></Td></Tr>";

echo "<Tr><Td align='right'>ชื่อกลุ่ม(งาน)&nbsp;&nbsp;&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='workgroup_desc' Size='20' value='$ref_result[workgroup_desc]' ></Td></Tr>";
...
$url_link="file=workgroup";  // 2_กำหนดลิงค์ฺ
...
echo "<Tr><Td colspan='7' align='left'><INPUT TYPE='button' name='smb' value='เพิ่มกลุ่ม' onclick='location.href=\"?file=workgroup&index=1\"'</Td></Tr>";
