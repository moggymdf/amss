...
<CENTER>
<h2>คะแนนสอบ O-NET และการประเมิน แบบที่ 2</h2>
<h3><?php
if(isset($_REQUEST['class_index'])){
...
echo "<Table width='95%' Border='0' Bgcolor='#Fcf9d8'>";
  echo "<Tr bgcolor='#FFCCCC'><Td  align='center' width='4%'>ที่</Td><Td  align='center' width='17%'>โรงเรียน</Td><Td  align='center' width='7%'>ภาษาไทย</Td><td align='center' width='7%' >คณิตศาสตร์</td><Td align='center'  width='7%'>วิทยาศาสตร์</Td><Td align='center' width='7%' >สังคมศึกษา</Td><Td align='center'  width='7%'>ภาษาอังกฤษ</Td><Td align='center' width='7%' >สุขศึกษา</Td><Td align='center'  width='7%'>ศิลปะ</Td><Td align='center' width='7%' >การงาน</Td><Td align='center' width='7%' >เฉลี่ย</Td><Td align='center' >ผลการประเมิน</Td></Tr>";
...
While ($result_1 = mysqli_fetch_array($dbquery)){
			if($_REQUEST['ed_year']==""){
			$strQuery = "select thai, math, science, social, english, health, art, vocation, score_avg from achievement_main where test_type='1' and test_class='$_REQUEST[class_index]' and ed_year='$year_ar[1]' and school='$result_1[school]' ";
			}
			else{
			$strQuery = "select thai, math, science, social, english, health, art, vocation, score_avg from achievement_main where test_type='1' and test_class='$_REQUEST[class_index]' and ed_year='$_REQUEST[ed_year]' and school='$result_1[school]' ";
			}
		...
		if($score_avg>0){
		 echo "<Tr bgcolor=$color><Td  align='center' >$M</Td><Td  align='left' >$result_1[school] $result_1[school_name]</Td><Td  align='center'>$thai</Td><td align='center' >$math</td><Td align='center'>$science</Td><Td align='center'>$social</Td><Td align='center'>$english</Td><Td align='center' >$health</Td><Td align='center'>$art</Td><Td align='center'>$vocation</Td><Td align='center' >$score_avg</Td><Td align='left' >";
		 //คะแนนจุดตัด
		$a=60;
		$b=30;
		$color[2]="#00CC00";
