...
<CENTER>
<h3>คะแนนสอบ NT และการประเมิน</h3>
<h3><?php echo $class_ar[$_REQUEST['class_index']] ?></h3>
<?php
echo "<form id='frm1' name='frm1'>";
echo "<table width='98%' align='center'><tr><td align='right'>";
...
echo "<Table width='98%' Border='0' Bgcolor='#Fcf9d8'>";
  echo "<Tr bgcolor='#FFCCCC'><Td  align='center'>ปีการศึกษา</Td><Td align='center'>เฉลี่ย</Td><Td align='center' >ผลการประเมิน</Td></Tr>";
$M=1;
...
function goto_display(val){
	if(val==1){
		callfrm("?option=achievement&task=main/report4_1_mobile");
		}
}
</script>
