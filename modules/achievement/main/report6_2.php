...
<CENTER>
<h2>คะแนนสอบ LAS และการประเมิน แบบที่ 2</h2>
<h3><?php
if(isset($_REQUEST['class_index'])){
...
While ($result_1 = mysqli_fetch_array($dbquery)){
			if($_REQUEST['ed_year']==""){
			$strQuery = "select thai, math, science, social, english, health, art, vocation, score_avg from achievement_main where test_type='3' and test_class='$_REQUEST[class_index]' and ed_year='$year_ar[1]' and school='$result_1[school]' ";
			}
			else{
			$strQuery = "select thai, math, science, social, english, health, art, vocation, score_avg from achievement_main where test_type='3' and test_class='$_REQUEST[class_index]' and ed_year='$_REQUEST[ed_year]' and school='$result_1[school]' ";
			}
