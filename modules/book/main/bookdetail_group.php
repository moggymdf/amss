...
"SELECT * FROM  bookregister_year WHERE year_active='1' and  start_receive_num!='0' and school_code is null ") ;
				...
				$sql = "insert into bookregister_receive(year, register_number, book_no, signdate, book_from, book_to, subject, register_date, ref_id, officer, book_link, secret, workgroup) values ('$result_start[year]', '$register_number', '$bookno', '$row2[signdate]', '$sender', 'สำนักงานเขตพื้นที่การศึกษา', '$subject', '$day_now', '$ref_id', '$user', '$book_link', '$secret','$result_permission[p2]')";
...
if ($level==1) {
	...
	<table border="0" width="480" id="table1" style="border-collapse: collapse; border: 1px dotted #FF00FF; ; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" cellpadding="2" >
		...
		<tr>
			...
			<p align="left"><font size="2" color="#993366">&nbsp;เรื่อง : </font><FONT SIZE="2" COLOR="#9900CC"><?php echo $subject;?></FONT> [<?php echo $img_level;?>]
			</td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;เลขทะเบียนหนังสือรับ : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $result_register_num['register_number']; ?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;หนังสือลงวันที่ : </font> <FONT SIZE="2" COLOR="#9900CC"><?php echo $signdate;?></font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;ส่งโดย : </font><FONT SIZE="2" COLOR="#9900CC"><?php echo $sender;?>&nbsp;[<?php echo $row_name['name'];?>&nbsp;<?php echo $row_name['surname'];?>]</font></td>
		</tr>
		<tr>
			<td width="449" align="left" colspan="2" style="border: 1px dotted #808000">
			<font size="2" color="#993366">&nbsp;วันเวลาที่ส่ง : </font><FONT SIZE="2" COLOR="#9900CC"><?php echo $send_date;?></font> </td>
		</tr>
		<tr>
			<td width="85" align="left" style="border: 1px dotted #808000"><font size="2" color="#993366">&nbsp;เนื้อหาโดยสรุป</font></td>
...
?>
		...
		<tr>
			...
			<table border="1" width="95%" id="table3" style="border-collapse: collapse" bordercolor=#669999 cellpadding="2">
		<?php
...
<table border="0" width="100%" style="border-collapse: collapse">
		<tr>
			<td bgcolor="#800000"><font face="Tahoma"><font size="2">&nbsp;</font><span lang="th"><font size="2" color="#FFFFFF"><B>กรุณาเลือกผู้รับหนังสือไปดำเนินการ</B></font></span></font> </td>
		</tr>
		</table>
...
$num_select = mysqli_num_rows ($result_select) ;
			if ($num_select==0) {
			   ?>
				  <TD  width="25%" align="left">&nbsp;&nbsp;&nbsp;<input type="radio" name="s_id" value="<?php echo $person_id;?>"><FONT SIZE="2" COLOR="#660099"><?php echo $prename.$name." ".$surname;?></FONT></TD>
  ...
  <div align="center">
	<table border="0" width="400"  style="border-collapse: collapse" bgcolor="#EAFFF0">
		<form method="POST" action="" name="form2" >
			<tr>
				<td>&nbsp;<b><font size="2" color="#800080">รายชื่อบุคคลที่ส่งหนังสือให้แล้ว
...
while ($r2=mysqli_fetch_array($result2)) {
	$send_to = $r2['send_to'] ;
?>&nbsp;<FONT SIZE="2" COLOR="">&nbsp;<FONT SIZE="2" COLOR=""><A HREF="bookdetail_group.php?index=2&sd_index=<?php echo $r2['id'];?>&b_id=<?php echo $_REQUEST['b_id'];?> "><IMG SRC="../../../images/b_drop.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT="ลบออก"></A>&nbsp; <?php echo $list2;?>. <?php echo $office_name_ar[$send_to]; ?>&nbsp;
