...
//select เลขทะเบียนหนังสือรับ
				$query_register_num=mysqli_query($connect,
"select  register_number from bookregister_receive where ref_id='$ref_id' ");
...
if ($level==1) {
	...
	<div align="center">
	<table border="0" width="500" id="table1" style="border-collapse: collapse; border: 1px dotted #FF00FF; ; padding-left:4px; padding-right:4px; padding-top:1px; padding-bottom:1px" cellpadding="2" >
		<tr>
...
$dbquery_name = mysqli_query($connect,
$sql_name);
$M=1;
