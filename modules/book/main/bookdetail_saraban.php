...
<table border="0" width="100%" style="border-collapse: collapse">
		<tr>
			<td bgcolor="#800000"><font face="Tahoma"><font size="2">&nbsp;</font><span lang="th"><font size="2" color="#FFFFFF"><B>กรุณาเลือกกลุ่มผู้รับหนังสือไปดำเนินการ</B></font></span></font> </td>
		</tr>
		</table>
...
$num_select = mysqli_num_rows ($result_select) ;
			if ($num_select==0) {
			   ?>
				  <TD  width="25%" align="left">&nbsp;&nbsp;&nbsp;<input type="radio" name="s_id" value="<?php echo $workgroup;?>"><FONT SIZE="2" COLOR="#660099"><?php echo $workgroup_desc;?></FONT></TD>
  ...
  <div align="center">
	<table border="0" width="400"  style="border-collapse: collapse" bgcolor="#EAFFF0">
		<form method="POST" action="" name="form2" >
			<tr>
				<td>&nbsp;<b><font size="2" color="#800080">รายชื่อกลุ่มที่ส่งหนังสือให้แล้ว
