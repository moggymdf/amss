...
<table border="0" width="100%" style="border-collapse: collapse">
		<tr>
			<td bgcolor="#800000"><font face="Tahoma"><font size="2">&nbsp;</font><span lang="th"><font size="2" color="#FFFFFF"><B>ส่งหนังสือคืนให้สารบรรณโรงเรียน</B></font></span></font> </td>
		</tr>
		</table>
...
while ($r2=mysqli_fetch_array($result2)) {
	$send_to = $r2['send_to'] ;
?>&nbsp;<FONT SIZE="2" COLOR="">&nbsp;<FONT SIZE="2" COLOR=""><A HREF="bookdetail_school_person.php?index=2&sd_index=<?php echo $r2['id'];?>&b_id=<?php echo $_REQUEST['b_id'];?> "><IMG SRC="../../../images/b_drop.png" WIDTH="16" HEIGHT="16" BORDER="0" ALT="ลบออก"></A>&nbsp; <?php echo $list2;?>. <?php echo $office_name_ar[$send_to]; ?>&nbsp;
