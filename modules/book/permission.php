...
echo "<Tr><Td align='right' width='50%'>เจ้าหน้าที่สารบรรณกลาง สพท.&nbsp;&nbsp;&nbsp;&nbsp;</Td>";
...
echo "<Tr><Td align='right' width='50%'>เจ้าหน้าที่สารบรรณกลุ่ม&nbsp;&nbsp;&nbsp;&nbsp;</Td>";
...
While ($result = mysqli_fetch_array($dbquery))
   {
		if($result[workgroup]==$ref_result['p2']){
...
echo "<Tr bgcolor='#FFCCCC'><Td  align='center'>ที่</Td><Td  align='center'>ชื่อเจ้าหน้าที่</Td><td  align='center'>สารบรรณกลาง<br>สพท.</td></Td><td  align='center'>สารบรรณกลุ่ม</td><Td align='center' width='50'>ลบ</Td><Td align='center' width='50'>แก้ไข</Td></Tr>";
$M=1;
While ($result = mysqli_fetch_array($dbquery))
	{
		$id = $result['id'];
...
echo "<br>";
echo "&nbsp;&nbsp;&nbsp;<b>หมายเหตุ</b>&nbsp;บุคลากรในสำนักงานให้สามารถเป็นเจ้าหน้าที่สารบรรณกลุ่มได้เพียงกลุ่มเดียวเท่านั้น";
?>
<script>
