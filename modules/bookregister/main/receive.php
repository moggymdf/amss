...
if($_REQUEST['workgroup']!=""){
echo "ส่งออก[Excel]เฉพาะที่ลงทะเบียนเอกสารกระดาษ<a href='modules/bookregister/main/export_to_excel.php?workgroup=$_REQUEST[workgroup]' target='_blank'>[คลิก]</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ส่งออก[Excel]ทั้งหมด<a href='modules/bookregister/main/export_to_excel2.php?workgroup=$_REQUEST[workgroup]' target='_blank'>[คลิก]</a>";
}
echo "</td></tr>";
echo "</table>";
}  //end index
