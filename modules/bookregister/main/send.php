...
if($_REQUEST['search_index']==1){
		if($_REQUEST['department']!=""){
		$sql="select * from bookregister_send where $_REQUEST[field] like '%$_REQUEST[search]%' and department='$_REQUEST[department]' order by year,register_number limit $start,$pagelen ";
		}
		else{
