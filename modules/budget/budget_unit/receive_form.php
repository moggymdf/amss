...
echo "<Center>";
echo "<Font Size='3'><B>เพิ่มข้อมูลการโอนเปลียนแปลงการจัดสรรงบประมาณรายจ่าย ปีงบประมาณ $year_active_result[budget_year]</B></Font>";
echo "</Cener>";
echo "<Br><Br>";
echo "<Table width='85%' Border='0' Bgcolor='#Fcf9d8'>";
echo "<Tr><Td align='right' width='25%'>เลขที่ใบงวด&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='num' id='num' Size='3' maxlength='3' value='$num' onkeydown='digitOnly()'></Td></Tr>";
...
echo "<Tr><Td align='right'>รายการ&nbsp;&nbsp;</Td><Td align='left'><Input Type='Tex't Name='item' Size='70'></Td></Tr>";
echo   "<tr><td align='right'>รายละเอียด&nbsp;&nbsp;</td>";
echo   "<td><div align=left><textarea  name='detail' cols='40' rows='4'></textarea></div></td></tr>";
echo "<Tr><Td align='right'>จำนวนเงิน&nbsp;&nbsp;</Td><Td align='left'><Input Type='Text' Name='money' Size='10' onkeydown='digitOnly()'>&nbsp;บาท</Td></Tr>";
echo "</Table>";
echo "<Br>";
