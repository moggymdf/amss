...
echo "<Tr align='left'><Td ></Td><Td>งบรายจ่าย</Td>";
echo "<td><div align='left'><Select  name='pay_group_id' id='pay_group_id' size='1'>";
echo  "<option  value = ''>เลือก</option>" ;
echo  "<option value =1>1 งบบุคลากร</option>";
echo  "<option value =2>2 งบดำเนินงาน</option>";
echo  "<option value =3>3 งบลงทุน</option>";
echo  "<option value =4>4 งบเงินอุดหนุน</option>";
echo  "<option value =5>5 งบรายจ่ายอื่น</option>";
echo  "<option value =6>6 งบกลาง</option>";
echo  "<option value =7>7 งบอื่นๆ</option>";

echo "</select>";
echo "</div></td></tr>";

echo "<Tr align='left'><Td width=20></Td><Td>รหัสประเภทรายการจ่าย</Td><Td><Input Type='Text' Name='pay_type_id' id='pay_type_id' Size='5' onkeydown='integerOnly()'></Td></Tr>";

echo "<Tr align='left'><Td ></Td><Td>ชื่อประเภทรายการจ่าย</Td><Td><Input Type='Text' Name='pay_type_name' id='pay_type_name' Size='40'></Td></Tr>";
echo "<Br>";
echo "</Table>";
echo "<Br>";
...
else if($ref_result['pay_group_id']==6){
$select6="selected";
}
else if($ref_result['pay_group_id']==7){
$select7="selected";
}
...
echo "<td><div align='left'><Select  name='pay_group_id' id='pay_group_id' size='1'>";
echo  "<option  value = ''>เลือก</option>" ;
echo  "<option value =1 $select1>1 งบบุคลากร</option>";
echo  "<option value =2 $select2>2 งบดำเนินงาน</option>";
echo  "<option value =3 $select3>3 งบลงทุน</option>";
echo  "<option value =4 $select4>4 งบเงินอุดหนุน</option>";
echo  "<option value =5 $select5>5 งบรายจ่ายอื่น</option>";
echo  "<option value =6 $select6>6 งบกลาง</option>";
echo  "<option value =7 $select7>7 งบอื่นๆ</option>";
echo "</select>";
echo "</div></td></tr>";

echo "<Tr align='left'><Td width=20></Td><Td>รหัสประเภทรายการจ่าย</Td><Td><Input Type='Text' Name='pay_type_id' id='pay_type_id' Size='5' value='$ref_result[pay_type_id]' onkeydown='integerOnly()'></Td></Tr>";

echo "<Tr align='left'><Td ></Td><Td>ชื่อประเภทรายการจ่าย</Td><Td><Input Type='Text' Name='pay_type_name' id='pay_type_name' Size='60' value='$ref_result[pay_type_name]'></Td></Tr>";
echo "<Br>";
echo "</Table>";
echo "<Br>";
