...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>อนุมัติจ่ายเงินทดรองราชการ ปีงบประมาณ$year_active_result[budget_year]</strong></font></td></tr>";
echo "</table>";
}
...
echo "<Center>";
echo "<Font color='#006666' Size=3><B>อนุมัติยืมเงินทดรองราชการ ปีงบประมาณ $year_active_result[budget_year]</B></Font>";
echo "</Cener>";
echo "<Br><Br>";
...
if ($index==6){
$rec_date = date("Y-m-d");
$sql = "update budget_reserve_money set approve='$_POST[approve]',
...
echo "<Tr ><Td colspan='7' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=budget&task=main/approve_reserve&page=$_GET[page]\"'></Td></Tr>";
...
$url_link="option=budget&task=main/approve_reserve";
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='30'>ที่</Td><Td width='70'>วดป</Td><Td width='70'>ที่เอกสาร</Td><Td width='75'>เลขที่อ้างอิง</Td><Td>รายการ</Td><Td width='110'>จำนวนเงิน</Td><Td width='60'>รายละเอียด</Td><Td width='60'>อนุมัติ</Td><Td width='60'>แก้ไข</Td></Tr>";
...
$t_year=($rec_year+543)-2500;
		...
		$approve_pic="<a href=?option=budget&task=main/approve_reserve&id=$id&index=6.5&page=$page><img src=./images/yellow.gif border='0' alt='คลิกอนุมัติจ่ายเงินทดรองราชการ'></a>";
		}

echo "<Tr bgcolor=$color><Td align='center'>$N</Td> <Td>$rec_day $t_month[$rec_month] $t_year</Td><Td align=left>$doc</Td><Td align='center'>";
if($refer_wd_id>0){
echo "<a href=?option=budget&task=main/refer_wd&id=$refer_wd_id&page=$page&back_page=approve_reserve>$refer_wd_id</a>";
}
echo "</Td><Td align=left>$item</Td><Td align='right'>$pay_amount</Td><Td align='center'><a href=?option=budget&task=main/approve_reserve&index=7&id=$id&page=$page><img src=./images/browse.png border='0' alt='รายละเอียด'></a></Td><td align='center'>$approve_pic</td>";
echo "<Td align='center'><a href=?option=budget&task=main/approve_reserve&index=5&id=$id&page=$page><img src=images/edit.png border='0' alt='แก้ไข'></a></div></Td></Tr>";
$M++;
...
function goto_url_update(val){
	if(val==0){
		callfrm("?option=budget&task=main/approve_reserve");   // page ย้อนกลับ
	}else if(val==1){
	callfrm("?option=budget&task=main/approve_reserve&index=6");   //page ประมวลผล
	}
}
