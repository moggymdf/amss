...
//จบแยกหน้า
		...
		$budget_type_ar[$type_id]=$type_name;
		}
...
echo "<Tr bgcolor=#FFCCCC align='center'><Td width='30'>ที่</Td><Td width='70'>วดป</Td><Td width='100'>ที่เอกสาร</Td><Td>รายการ</Td><td width='200'>ประเภท</td><Td width='180'>ลักษณะรายการ</Td><Td width='120'>จำนวนเงิน</Td><Td width='80'>รายละเอียด</Td><Td width='40'>ลบ</Td><Td width='40'>แก้ไข</Td></Tr>";
...
$t_year=($rec_year+543)-2500;
		...
		echo "<Tr bgcolor=$color><Td align='center'>$N</Td> <Td>$rec_day $t_month[$rec_month] $t_year</Td><Td align=left>$doc</Td><Td align=left>$item</Td>";

echo "<td>$budget_type_ar[$type]</td>";

echo "<Td>$budget_status[$status]</Td><Td align='right'>$change_amount</Td><Td align='center'><a href=?option=budget&task=main/change_ex_bud&index=7&id=$id&page=$page&type_id_index=$_REQUEST[type_id_index]><img src=./images/browse.png border='0' alt='รายละเอียด'></a></Td>";
...
function goto_url_update(val){
	if(val==0){
		callfrm("?option=budget&task=main/change_ex_bud&page=<?=$_REQUEST[page]?>");   // page ย้อนกลับ
	}else if(val==1){
