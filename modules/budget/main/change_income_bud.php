...
$sql = "select * from budget_main where budget_year='$year_active_result[budget_year]' and type_id between '300' and '399' and status between '5' and '10' order by rec_date,id limit $start,$pagelen";
...
echo "<Tr bgcolor=#FFCCCC align='center'><Td width='30'>ที่</Td><Td width='70'>วดป</Td><Td width='100'>ที่เอกสาร</Td><Td>รายการ</Td><td width='150'>ประเภท</td><Td width='180'>ลักษณะรายการ</Td><Td width='120'>จำนวนเงิน</Td><Td width='80'>รายละเอียด</Td><Td width='40'>ลบ</Td><Td width='40'>แก้ไข</Td></Tr>";
...
echo "<Td>$budget_status[$status]</Td><Td align='right'>$change_amount</Td><Td align='center'><a href=?option=budget&task=main/change_income_bud&index=7&id=$id&page=$page&type_id_index=$_REQUEST[type_id_index]><img src=./images/browse.png border='0' alt='รายละเอียด'></a></Td>";
