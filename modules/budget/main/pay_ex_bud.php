...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>ทะเบียนสั่งจ่ายเงินนอกงบประมาณ ปีงบประมาณ$year_active_result[budget_year]</strong></font></td></tr>";
echo "</table>";
}
...
echo "<Center>";
echo "<Font color='#006666' Size=3><B>เพิ่มข้อมูลสั่งจ่ายเงินนอกงบประมาณ ปีงบประมาณ$year_active_result[budget_year]</Font>";
echo "</Cener>";
echo "<Br><Br>";
...
echo  "<option  value = ''>เลือก</option>" ;
$sql = "select  * from  budget_type where category_id='1' and budget_year='$year_active_result[budget_year]' order by type_id";
$dbquery = mysqli_query($connect,$sql);
While ($result = mysqli_fetch_array($dbquery))
   {
...
echo "<form id='frm1' name='frm1'>";
echo "<Center>";
echo "<Font color='#006666' Size=3><B>แก้ไขทะเบียนสั่งจ่ายเงินนอกงบประมาณ ปีงบประมาณ$year_active_result[budget_year]</B></Font>";
echo "</Cener>";
echo "<Br><Br>";
...
echo "<form id='frm1' name='frm1'>";
echo "<Center>";
echo "<Font color='#006666' Size=3><B>รายละเอียดสั่งจ่ายเงินนอกงบประมาณ ปีงบประมาณ$year_active_result[budget_year]</B></Font>";
echo "</Cener>";
echo "<Br><Br>";
...
//จบแยกหน้า
		...
		echo "<Tr><Td align='left'><INPUT TYPE='button' name='smb' value='เพิ่มรายการสั่งจ่าย' onclick='location.href=\"?option=budget&task=main/pay_ex_bud&index=1\"'></Td>";
		echo "<td>";
		...
		$sql_type = "select  * from  budget_type where category_id='1' and budget_year='$year_active_result[budget_year]' order by type_id";
...
if($refer_wd_id>0){
echo "<a href=?option=budget&task=main/refer_wd&id=$refer_wd_id&page=$page&back_page=pay_ex_bud&type_id_index=$_REQUEST[type_id_index]>$refer_wd_id</a>";
}
echo "</Td>";

echo "<td align='center'>";
if($refer_deega_id>0){
echo "<a href=?option=budget&task=main/refer_deega&id=$refer_deega_id&page=$page&back_page=pay_ex_bud>$refer_deega_id</a>";
}
echo "</td>";
...
echo "<Td align='right'>$pay_amount</Td><Td align='center'><a href=?option=budget&task=main/pay_ex_bud&index=7&id=$id&page=$page&type_id_index=$_REQUEST[type_id_index]><img src=./images/browse.png border='0' alt='รายละเอียด'></a></Td>";
...
echo "<Tr bgcolor=#FFCCCC><Td></Td><Td></Td><Td></Td><Td></Td><Td></Td><Td align='center'>รวม</Td><Td></Td><Td align='center'>$pay_item_total</Td><Td></Td><Td></Td><Td></Td><Td></Td><Td></Td></Tr>";
