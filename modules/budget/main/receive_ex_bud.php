...
echo  "<table width=95% border=0 align=center>";
echo "<tr bgcolor='#FFCCCC' align='center'><td width='50'>ที่</td><td width='70'>วดป</td><td width='100'>ที่เอกสาร</td><td>รายการ</td><td width='250'>ประเภท</td><td width='140'>ลักษณะรายการ</td><td width='90'>จำนวนเงิน</td><Td width='90'>รายละเอียด</Td><td width='40'>ลบ</td><td width='40'>แก้ไข</td><td width='60'>รวม</td></tr>";
...
$t_year=($rec_year+543)-2500;
		...
		echo "<Td valign='top'>$budget_status[$status]</Td><Td align='right'>$receive_amount</Td>";
...
echo "<Tr bgcolor=#FFCCCC><Td></Td><Td></Td><Td></Td><Td align='center'>รวม</Td><Td></Td><Td></Td><Td align='center'>$receive_item_total</Td><Td></Td><Td></Td><Td></Td><Td></Td></Tr>";
echo "</Table>";
}
?>
<script>
