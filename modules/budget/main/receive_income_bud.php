...
if($_REQUEST['type_id_index']!=""){
$sql = "select * from  budget_main where budget_year='$year_active_result[budget_year]' and status between '1' and '2' and type_id='$_REQUEST[type_id_index]' order by rec_date, id limit $start,$pagelen";
}
else{
$sql = "select * from budget_main where budget_year='$year_active_result[budget_year]' and type_id between '300' and '399' and status between '1' and '2' order by rec_date, id limit $start,$pagelen";
}
...
echo  "<table width='95%' border='0' align='center'>";
echo "<Tr bgcolor=#FFCCCC align='center'><Td width='30'>ที่</Td><Td width='70'>วดป</Td><Td width='90'>ที่เอกสาร</Td><Td>รายการ</Td><td width='250'>ประเภท</td><Td width='130'>ลักษณะรายการ</Td><Td width='100'>จำนวนเงิน</Td><Td width='90'>รายละเอียด</Td><Td width='40'>ลบ</Td><Td width='40'>แก้ไข</Td><td width='60'>รวม</td></Tr>";
$N=(($page-1)*$pagelen)+1;
$M=1;
While ($result = mysqli_fetch_array($dbquery))
	{
...
$t_year=($rec_year+543)-2500;
		...
		echo "<Tr bgcolor=$color><Td align='center'>$N</Td> <Td>$rec_day $t_month[$rec_month] $t_year</Td><Td align=left>$doc</Td><Td align=left>$item";
		echo "</Td>";
		echo "<td>$budget_type_ar[$type]</td>";
		echo "<Td>$budget_status[$status]</Td><Td align='right'>$receive_amount</Td>";
...
echo "<Tr bgcolor=#FFCCCC><Td></Td><Td></Td><Td></Td><Td></Td><Td></Td><Td align='center'>รวม</Td><Td align='center'>$receive_item_total</Td><Td></Td><Td></Td><Td></Td><Td></Td></Tr>";
echo "</Table>";
}
