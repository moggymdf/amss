...
//ส่วนแสดงรายละเอียด
$sql = "select * from  budget_deega where deega_num='$_GET[id]' and budget_year='$year_active_result[budget_year]' ";
$dbquery = mysqli_query($connect,$sql);
...
echo "<Tr><Td colspan='7' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=budget&task=main/$_GET[back_page]&page=$_GET[page]\"'></Td></Tr>";
