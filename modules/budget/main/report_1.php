...
for($i=1;$i<$rd;$i++)
{
		...
		echo "<Tr bgcolor='#FFFFC''><Td align='center'>$i</Td><Td align='center'><font>$code_proj_plan_ar[$i]</font></Td><Td colspan='2'>$name_proj_plan_ar[$i]</Td><Td align='right'><font color='#FF0033'>$budget_project</font></Td><Td align='right'><font color='#FF0033'>$proj_sum</font></Td><Td align='right'><font color='#FF0033'>$net_proj2</font></Td><Td align='right'><font color='#FF0033'>$proj_percent</font></Td><Td></Td></Tr>";
		$acti_num=0;
		for($x=1;$x<$re;$x++)
		{
				if($code_proj_plan_ar[$i]==$code_proj_acti_ar[$x])
