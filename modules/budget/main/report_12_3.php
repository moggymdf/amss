<br />
<div align="center">
        <font color="#006666" size="3"><strong>รายละเอียดฎีกา</strong></font>
 </div>
...
echo "<Tr ><Td colspan='7' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=budget&task=main/report_12_2&page=$_GET[page]&year_index=$year_active_result[budget_year]&project=$_GET[project]&pay_group=$_GET[pay_group]\"'></Td></Tr>";
