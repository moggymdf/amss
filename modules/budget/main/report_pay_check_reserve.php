...
echo "<Tr ><Td colspan='7' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=budget&task=main/report_pay_check_reserve&page=$_GET[page]\"'></Td></Tr>";
...
$url_link="option=budget&task=main/report_pay_check_reserve";
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='30'>ที่</Td><Td width='70'>วดป</Td><Td>รายการ</Td><Td width='110'>จำนวนเงิน</Td><Td width='60'>รายละเอียด</Td><Td width='60'>อนุมัติ</Td><Td width='60'>จ่ายเงิน</Td></Tr>";
...
echo "<Td align=left>$item</Td><Td align='right'>$pay_amount</Td><Td align='center'><a href=?option=budget&task=main/report_pay_check_reserve&index=7&id=$id&page=$page><img src=./images/browse.png border='0' alt='รายละเอียด'></a></Td><td align='center'>$approve_pic</td><td align='center'>$pay_pic</td>";
echo "</Tr>";
$M++;
