...
echo "<Tr ><Td colspan='4' align='left'>";
			...
			if(	$num_person>=1){
			echo "<INPUT TYPE='button' name='smb' value='เพิ่มเอกสารในแฟ้ม$result_file[file_name]' onclick='location.href=\"?option=cabinet&task=main/ctr_document&cabinet_id=$_REQUEST[cabinet_id]&tray_id=$_REQUEST[tray_id]&file_id=$_REQUEST[file_id]&add_index=1&page=$_REQUEST[main_page]\"'>";
			}
echo "<Td colspan='5' align='right'><INPUT TYPE='button' name='smb' value='<<กลับไปตู้เอกสาร' onclick='location.href=\"?option=cabinet&task=main/ctr_document&page=$_REQUEST[main_page]\"'></Td></Tr>";
...
echo "<Td></Td><Td></Td><Td></Td></Tr>";
			...
			$num_person=mysqli_num_rows($dbquery_person);
			////
							if($size_sum<100 and $num_person>=1){
