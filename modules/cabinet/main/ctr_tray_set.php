...
While ($result = mysqli_fetch_array($dbquery))
	{
		$id = $result['id'];
					...
					///////////////
echo "<Tr  bgcolor='#CCCCCC' align='center'><Td>$result[cabinet_id]</Td><td colspan='3' align='left'>$result[cabinet_name]&nbsp;&nbsp;[สิทธิ์ผู้ใช้&nbsp;:&nbsp;$result_workgroup[workgroup_desc]]</td><Td align='center'>$result[cabinet_size]</Td> <Td align='left'>$result[prename]$result[name]&nbsp;$result[surname]</Td>";
