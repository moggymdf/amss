...
echo "<INPUT TYPE='button' name='smb' value='ยืนยัน' onclick='location.href=\"?option=meeting&task=main/meeting&index=3&id=$_GET[id]&page=$_REQUEST[page]\"'>
...
echo "<Tr><Td colspan='6' align='left'><INPUT TYPE='button' name='smb' value='จองห้องประชุม' onclick='location.href=\"?option=meeting&task=main/meeting&index=1&room_index=$room_index\"'></Td>";
