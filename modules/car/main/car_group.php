...
echo "</Td>";
echo "<Td valign='top' align='center'><a href=?option=car&task=main/car_group&index=7&id=$id&page=$page&car_index=$car_index><img src=images/browse.png border='0' alt='รายละเอียด'></Td>";
