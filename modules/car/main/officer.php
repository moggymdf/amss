...
echo "<Tr><td colspan='9'></td><Td colspan='4' align='left'><INPUT TYPE='checkbox' name='allchk'  id='allckk' onclick='CheckAll()'>เลือก/ไม่เลือกทั้งหมด</Td></Tr>";
...
function goto_url_update2(val){
	if(val==0){
		...
		callfrm("?option=meeting&task=main/officer&index=4&page=<?=$_REQUEST[page]?>");   //page ประมวลผล
	}
}
