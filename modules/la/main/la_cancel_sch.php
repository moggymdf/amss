...
$sql_name = "select * from person_sch_main where person_id='$user'";
}
else{
...
echo "<Tr align='left'><Td align='right'>เรื่อง&nbsp;&nbsp;</Td><Td>ขอยกเลิกวันลา  <Input Type='radio' Name='la_type' value='1'>ลาป่วย&nbsp;&nbsp;<Input Type='radio' Name='la_type' value='2'>ลากิจ&nbsp;&nbsp;<Input Type='radio' Name='la_type' value='3'>ลาคลอด</Td></Tr>";
...
echo "</td></tr>";
echo "<Tr align='left'><Td align='right'><span style='display:none'>ไม่ต้องผ่านผู้บังคับบัญชาขั้นต้น&nbsp;&nbsp;</span></Td><Td><span style='display:none'><input type='checkbox'  name='no_comment' id='no_comment' value='1'>&nbsp;&nbsp;</span></Td></Tr>";
echo "<Tr align='left'><Td align='right'>เลือกผู้อนุมัติ&nbsp;&nbsp;</Td><Td><Select  name='grant_p_selected'  size='1'>";
echo  "<option  value = ''>เลือก</option>" ;
$sql = "select * from person_main where status='0' and position_code='1'";
...
echo "<INPUT TYPE='button' name='smb' value='ยืนยัน' onclick='location.href=\"?option=la&task=main/la_cancel_sch&index=3&id=$_GET[id]&page=$_REQUEST[page]\"'>
		&nbsp;&nbsp;<INPUT TYPE='button' name='back' value='ยกเลิก' onclick='location.href=\"?option=la&task=main/la_cancel_sch&page=$_REQUEST[page]\"'";
echo "</td></tr></table>";
}
...
$rec_date=$ref_result['rec_date'];
		...
		echo "<Tr align='left'><Td align='right'>เรื่อง&nbsp;&nbsp;</Td><Td>ขอยกเลิกวันลา&nbsp;<Input Type='radio' Name='la_type' value='1' $check1>ลาป่วย&nbsp;&nbsp;<Input Type='radio' Name='la_type' value='2' $check2>ลากิจ&nbsp;&nbsp;<Input Type='radio' Name='la_type' value='3' $check3>ลาคลอด</Td></Tr>";
...
echo "<Tr align='left'><Td align='right'><span style='display:none'>ไม่ต้องผ่านผู้บังคับบัญชาขั้นต้น&nbsp;&nbsp;</span></Td><Td><span style='display:none'><input type='checkbox'  name='no_comment' id='no_comment' value='1' $no_comment_select>&nbsp;&nbsp;</span></Td></Tr>";
...
echo "<Tr ><Td colspan='2' align='right'><INPUT TYPE='button' name='smb' value='<<กลับหน้าก่อน' onclick='location.href=\"?option=la&task=main/la_cancel_sch&page=$_GET[page]\"'></Td></Tr>";
...
$rec_date=$ref_result['rec_date'];  //วดป วันขออนุญาต
...
$no_comment_select="";
		...
		echo "<Tr align='left'><Td align='right'></Td><Td><span style='display:none'><input type='checkbox'  name='no_comment' id='no_comment' value='1' $no_comment_select>&nbsp;ไม่ต้องผ่านผู้บังคับบัญชาขั้นต้น</span></Td></Tr>";
...
echo "<Tr><Td colspan='11' align='left'><INPUT TYPE='button' name='smb' value='ขอยกเลิกวันลา' onclick='location.href=\"?option=la&task=main/la_cancel_sch&index=1\"'></Td></Tr>";
...
echo "</Td>";
echo "<Td valign='top' align='center'><a href=?option=la&task=main/la_cancel_sch&index=7&id=$id&page=$page><img src=images/browse.png border='0' alt='รายละเอียด'></Td>";
if(($officer_sign=="") and ($group_sign=="") and ($commander_sign=="")){
echo "<Td valign='top' align='center'><a href=?option=la&task=main/la_cancel_sch&index=2&id=$id&page=$page><img src=images/drop.png border='0' alt='ลบ'></Td><Td valign='top'  align='center'><a href=?option=la&task=main/la_cancel_sch&index=5&id=$id&page=$page><img src=images/edit.png border='0' alt='แก้ไข'></a></Td>";
}
else{
echo "<td></td><td></td>";
}
...
function goto_url(val){
	if(val==0){
		callfrm("?option=la&task=main/la_cancel_sch");   // page ย้อนกลับ
	}else if(val==1){
		if(frm1.write_at.value == ""){
			...
			callfrm("?option=la&task=main/la_cancel_sch&index=4");   //page ประมวลผล
		}
	}
}
...
function goto_url_update(val){
	if(val==0){
		...
		if(frm1.write_at.value == ""){
			...
			callfrm("?option=la&task=main/la_cancel_sch&index=6");   //page ประมวลผล
		}
	}
}
