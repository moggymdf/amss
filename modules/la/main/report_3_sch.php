...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>รายการยกเลิกวันลา</strong></font></td></tr>";
echo "</table>";
echo "<br>";
...
//ส่วนของการแยกหน้า
$sql="select id from la_cancel where person_id='$_SESSION[login_user_id]'";
...
$sql_person = "select * from  person_sch_main where person_id='$person_id' ";
