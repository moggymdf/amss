...
echo "<ul id='nav' class='dropdown dropdown-horizontal'>";
	...
	echo "<li><a href='?option=la' class='dir'>ขออนุญาตลา</a>";
		echo "<ul>";
			echo "<li><a href='?option=la&task=main/la_main_sch'>บันทึกขออนุญาตลา</a></li>";
			echo "<li><a href='?option=la&task=main/la_cancel_sch'>ขอยกเลิกวันลา</a></li>";
	echo "</ul>";
	echo "</li>";
	}
	if($_SESSION['login_status']<=4){
	...
	if($_SESSION['login_status']==12){
	echo "<li><a href='?option=la&task=main/report_4_sch' class='dir'>รายงาน</a>";
		echo "<ul>";
			echo "<li><a href='?option=la&task=main/report_4_sch'>สถิติการลาป่วย กิจ คลอด</a></li>";
			echo "<li><a href='?option=la&&task=main/report_3_sch'>ขอยกเลิกวันลา</a></li>";
		echo "</ul>";
	echo "</li>";
	}
