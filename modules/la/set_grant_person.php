...
$sql = "select la_person_set.id, person_main.person_id, person_main.prename, person_main.name, person_main.surname, person_main.position_code, person_main.department, la_person_set.comment_person, la_person_set.grant_person from person_main left join la_person_set on person_main.person_id=la_person_set.person_id where person_main.status='0' order by person_main.department,person_main.position_code,person_main.person_order";
$dbquery = mysqli_query($connect,$sql);
