...
echo   "<td align='left'>&nbsp;&nbsp;ใช่&nbsp;&nbsp;<input  type=radio name='mail_permission' value='1'>&nbsp;&nbsp;ไม่ใช่&nbsp;&nbsp;<input  type=radio name='mail_permission' value='0'  checked></td></tr>";
...
$mail_permission=mysqli_real_escape_string($connect,$_POST['mail_permission']);

$rec_date = date("Y-m-d");
$sql = "insert into mail_permission (person_id, p1, officer,rec_date) values (?,?,?,?)";
    $dbquery_addmail = $connect->prepare($sql);
    $dbquery_addmail->bind_param("iiss", $personid,$mail_permission,$login_user_id,$rec_date);
...
echo   "<td align='left'>&nbsp;&nbsp;ใช่&nbsp;&nbsp;<input  type=radio name='mail_permission' value='1' $p1_check1>&nbsp;&nbsp;ไม่ใช่&nbsp;&nbsp;<input  type=radio name='mail_permission' value='0' $p1_check2></td></tr>";
...
$sql_update = "update mail_permission set  person_id=?, p1=?, officer=?, rec_date=? where id=?";
                    ...
                    $dbquery_update->bind_param("iissi", $person_id,$mail_permission,$login_user_id,$rec_date,$idpermis);
