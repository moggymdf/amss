...
$result1=mysqli_query($connect,"SELECT * FROM  person_sch_main WHERE status='0' and school_code='$_REQUEST[school_code]' order by position_code, name, surname ") ;
...
<BR><input name="boxchecked" type="hidden" id="boxchecked" value="<?php echo $list1?>"> <input name="sd_index" type="hidden"  value="<?php echo $sd_index?>"><input name="index" type="hidden"  value="1"><input name="school_code" type="hidden"  value="<?php echo $_REQUEST['school_code']?>">
