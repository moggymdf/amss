...
echo "<Tr align='center'><Td align='right'>วันเวลารายงาน&nbsp;</Td><Td alight='left'>$thai_date_report</Td></Tr>";
					if($ref_result['report_read']!=""){
					$report_read_date=thai_date_4($ref_result['report_read_date']);
					echo "<Tr align='center'><Td align='right'>วันเวลาผู้อนุมัติอ่านรายงาน&nbsp;</Td><Td alight='left'>$report_read_date</Td></Tr>";
					}
echo "</table>";
echo "</fieldset></td></tr></table>";
}
...
echo "<Tr><Td colspan='2' align='center'><TEXTAREA NAME='report' ROWS='15' COLS='100'>$report</TEXTAREA></Td></Tr>";
echo "</Table>";
echo "<Input Type=Hidden Name='id' Value='$_GET[id]'>";
echo "<Input Type=Hidden Name='page' Value='$_GET[page]'>";
echo "<br>";
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='60'>เลขที่</Td><Td width='100'>วันขออนุญาต</Td><Td>เรื่องราชการ</Td><Td>สถานที่</Td><Td width='100'>วันไปราชการ</Td><Td>พาหนะ</Td><Td width='50'>เอกสาร</Td><Td>อนุมัติ/คำสั่ง</Td><Td width='40'>รายละเอียด</Td><Td width='40'>ลบ</Td><Td width='100'>รายงาน</Td></Tr>";
...
echo "<Td valign='top' align='center'></Td><Td valign='top' align='center'><a href=?option=permission&task=main/permission_main&index=8&id=$id&page=$page>[เขียนรายงาน]</a></Td>";
}
else if($grant==1 && $report!=""){
echo "<Td valign='top' align='center'></Td><Td valign='top' align='center'><a href=?option=permission&task=main/permission_main&index=8&id=$id&page=$page>มีรายงาน</a>";
		if($result['report_read']!=""){
		echo "<br>";
		echo "<font size='1'>[ผู้อนุมัติอ่านแล้ว]</font>";
		}
echo "</Td>";
}
else{
