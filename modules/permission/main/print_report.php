...
<?php
echo "</Td></Tr>";
echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='60'>เลขที่</Td><Td width='100'>วันขออนุญาต</Td><Td>เรื่องราชการ</Td><Td>สถานที่</Td><Td width='100'>วันไปราชการ</Td><Td width='100'>พาหนะ</Td><Td width='150'>ผู้ขออนุญาต</Td><Td width='120'>ความเห็นผู้บังคับบัญชา<br>ขั้นต้น</Td><Td width='150'>อนุมัติ/คำสั่ง</Td><Td width='60'>หมายเหตุ</Td></Tr>";
...
echo "<font color='#339900'>$comment</font><br>";
		...
		echo "<br>";
		echo thai_date_3($result['comment_date']);
		}
}
else{
echo "";
...
echo "<img src=images/yes.png border='0'> อนุมัติ<br><font color='#339900'>$grant_comment</font><br>";
		...
		echo "<br>";
		echo thai_date_3($result['grant_date']);
		}
}
else if($grant==2){
...
<br />
&nbsp;&nbsp;<b>หมายเหตุ</b><br />&nbsp;&nbsp;&nbsp;&nbsp;การพิมพ์รายงาน แนะนำใช้เบาว์เซอร์ Google Chrome จะสะดวกต่อการปรับการพิมพ์แนวนอน
