...
if($report!=""){
echo "<a href=?option=permission&task=main/report_2&index=7&id=$id&page=$page>มี</a>";
}
echo "</Td>";

echo "<Td valign='top' align='center'><a href=?option=permission&task=main/report_2&index=7&id=$id&page=$page><img src=images/browse.png border='0' alt='รายละเอียด'></a></Td>";
echo "</Tr>";
