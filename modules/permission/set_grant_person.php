...
echo "<Tr align='center'><Td colspan='4'></Td><Td><font color='#006666' size='2'>ผู้ให้ความเห็นชอบ</font></Td><Td><font color='#006666' size='2'>ผู้อนุมัติ</font></Td></Tr>";

echo "<Tr bgcolor='#FFCCCC' align='center'><Td width='30'>ที่</Td><Td width='150'>ชื่อ</Td><Td>ตำแหน่ง</Td><Td>กลุ่ม</Td><Td width='150'>";
...
$sql = "select permission_person_set.id, person_main.person_id, person_main.prename, person_main.name, person_main.surname, person_main.position_code, person_main.department, permission_person_set.comment_person, permission_person_set.grant_person from person_main left join permission_person_set on person_main.person_id=permission_person_set.person_id where person_main.status='0' order by person_main.department,person_main.position_code,person_main.person_order";
$dbquery = mysqli_query($connect,$sql);
