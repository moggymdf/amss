...
<br />
<div align="center">
        <font color="#006666"><strong>การจัดสรรงบประมาณ ปี <?php echo $year_active_result['budget_year'] ?> </strong></font></p>
      </div>
<?php
...
echo "</select>";
*/
echo "&nbsp;<Select  name='workgroup' size='1' onchange='goto_url()'>";
...
echo "<Tr bgcolor='#FFCCCC' align='center'><Td>ที่</Td><Td>รหัส</Td><Td>โครงการ</Td><Td>กิจกรรม</Td><Td>งบประมาณ</Td><Td>ผู้รับผิดชอบ</Td></Tr>";

for($i=1;$i<$rd;$i++)
{
$budget_proj_plan_ar[$i]=number_format($budget_proj_plan_ar[$i],2);
echo "<Tr bgcolor='#FFFFC'><Td align='center'>$i</Td><Td align='center'>$code_proj_plan_ar[$i]</Td><Td colspan='2'>$name_proj_plan_ar[$i]</Td><Td align=right><font color='#FF0033'>$budget_proj_plan_ar[$i]</font></Td><Td>";
...
$type_text="";
					...
					echo "<Tr><Td ></Td><Td></Td><Td></Td><Td align=left><font color='#0000FF'>$code_acti_ar[$x]</font>&nbsp;$name_acti_ar[$x]</Td><Td align=right>$budget_acti</Td><Td></Td></Tr>";
					}
		}
}
$sum_momey_proj=number_format($sum_momey_proj,2);
echo "<Tr bgcolor='#FFCCCC' align='center'><Td></Td><Td></Td><Td></Td><Td>รวม</Td><Td>$sum_momey_proj</Td><Td></Td></Tr>";
echo "</Table>";
?>

<script>
function goto_url(val){
callfrm("?option=plan&task=check/check_1_mobile");
}
</script>
