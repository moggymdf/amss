...
<p><b><font size="2" color="blue">&nbsp;&nbsp;<?=$nameacti?></p>
<CENTER>
...
While($fetcharr = mysqli_fetch_array($result2) ) {
	...
	$sql = "SELECT *  FROM  plan_standard  where (code_acti=$code_acti and sd_year=$fetyear  and sd_level=$sd_level  and id_indicator=$fetcharr[id_indicator] and sd_id=$fetcharr[sd_id])  limit 1";
