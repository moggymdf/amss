...
<?php=$mcode_clus.'. '.$mname_clus?></font>
	   </td>
	 </tr>
	 </table>
</td>
...
<?php=$mcode_proj.'. '.$mname_proj?></font>
	   </td>
	 </tr>
	 </table>
</td>
...
<TABLE width="100%" border="0" borderColor=#FF0033 cellpadding="0" cellspacing="0" >
    <TR>
        <td><div align="center"><font color="#CC0000" size="2" face="MS Sans Serif"><strong><?php=$mname_proj?> </strong></font><br> </div></td>
    </TR>
    <tr>
      <TD>
            <TABLE width="100%"  border=0 borderColor=#99CC33 cellpadding="3" cellspacing="0">
		    <tr><td align="left" colspan='2'><font color="#003333" size="2" face="MS Sans Serif"><?php=$ThaiDateFull?></font></td></tr>
			<tr><td align="right"><b><font color="#003333" size="2" face="MS Sans Serif">เธงเธฑเธ- เน€เธ”เธทเธญเธ-เธเธต : </font></b></td>
                    ...
                    <td align="left"> <input size=6 type readonly=text name="vcode_acti" value=<?php=$vcode_acti?>>
                    </td></tr>
                 <tr>
...
echo "<br />";
		...
		echo "</select>";
				...
				<tr>
                    ...
                    <td align="left"> <textarea name='vname_acti' rows = '3' cols='50' ><?php=$vname_acti?></textarea>
                    </td></tr>
				<tr>
                    ...
                    <td align="left"> <script>
								var Y_date=<?php=$eYnum?>
								var m_date=<?php=$emnum?>
								var d_date=<?php=$ednum?>
				...
				<tr>
                    ...
                    <td align="left"> <script>
								var Y_date=<?php=$eYbudget?>
								var m_date=<?php=$embudget?>
								var d_date=<?php=$edbudget?>
								Y_date= Y_date+'/'+m_date+'/'+d_date
				...
				<tr>
                    ...
                    <td align="left"> <input  size=9 type=text  name="vbudget_acti" maxlength=9 value=<?php=$vbudget_acti?>>
					</td></tr>
				<tr>
                    <td align="right"><b><font color="#003333" size="2" face="MS Sans Serif">เธเธณเธเธงเธเน€เธเธดเธเธญเธเธธเธกเธฑเธ•เธด :</font></b></td>
                    <td align="left"> <input  size=9 type=text  name="vbudget_approve" maxlength=9 value=<?php=$vbudget_approve?>>
					</td></tr>
              </table>
		</TD>
	 </table>
