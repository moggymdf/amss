...
?>
	...
	<tr >
            <td align="right"  width='20%'  ><b><font size="2" face="MS Sans Serif">เลขประจำตัวประชาชน :</font></b></td>
                    <td  align="left"  width='30%'  > <input  size=13  type readonly=text name="vid_person" maxlength=13 value=<?php echo $vid_person?>><b><font size="3" face="MS Sans Serif" color="#FFFFFF">เลขประจำตัวประชาชน</font></b>
					</td></tr>
				<tr>
                    <td align="right"><b><font size="2" face="MS Sans Serif">add :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_add"  onClick="check( this.form )" ><b><font size="2" face="MS Sans Serif">  สิทธิ์การบันทึกข้อมูล</font></b>
                    </td></tr>
					<tr>
                    <td align="right"><b><font size="2" face="MS Sans Serif">edit :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_edit"  onClick="check( this.form )" ><b><font size="2" face="MS Sans Serif">  สิทธิ์การแก้ไขข้อมูล</font></b>
					</td></tr>
				<tr>
                    <td align="right"><b><font size="2" face="MS Sans Serif">delete :</font></b></td>
                    <td align="left"><input  type=checkbox  name="vperm_dele"  onClick="check( this.form )" ><b><font size="2" face="MS Sans Serif" >  สิทธิ์การลบข้อมูล</font></b>
					</td></tr>
               </table>
		</TD>
	 </table>
