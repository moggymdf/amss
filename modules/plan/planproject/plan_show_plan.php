...
<p align="center" STYLE="font-family: 'sans-serif', fantasy; font-size: 10pt; color:blue;font-weight: bold;">ปีงบประมาณ <?php echo $proj_year ?></Font></p>
...
echo "</tr>";
		...
		for($x=1;$x<$re;$x++)
		{
				...
				$type_text="<font color=#FF0000>ยังไม่ได้กำหนด</font>";
				}
