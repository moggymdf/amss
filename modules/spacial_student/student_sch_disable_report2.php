...
$url_link="option=spacial_student&task=student_sch_disable_report2&disable_type=$_REQUEST[disable_type]&index=9&id=$_REQUEST[id]&page2=$_GET[page2]&school=$_REQUEST[school]";  // 2_กำหนดลิงค์ฺ
...
echo "<INPUT TYPE='button' name='smb' value='<<กลับไปหน้ารายชื่อ' onclick='location.href=\"?option=spacial_student&task=student_sch_disable_report2&disable_type=$_REQUEST[disable_type]&page=$_GET[page2]&school=$_REQUEST[school]\"'>";
...
//ส่วนของการแยกหน้า
$pagelen=15;  // 1_กำหนดแถวต่อหน้า
$url_link="option=spacial_student&task=student_sch_disable_report2&disable_type=$_REQUEST[disable_type]&school=$_REQUEST[school]";  // 2_กำหนดลิงค์ฺ
if(($_REQUEST['disable_type']!="") and ($_REQUEST['school']!="")){
$sql = "select  * from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.disable_type='$_REQUEST[disable_type]' and spacial_student_disabled.school_code='$_REQUEST[school]' and spacial_student_disabled.school_code=student_main_main.school_code ";
}
else if(($_REQUEST['disable_type']=="") and ($_REQUEST['school']!="")){
$sql = "select  * from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.school_code='$_REQUEST[school]' and spacial_student_disabled.school_code=student_main_main.school_code";
}
else if(($_REQUEST['disable_type']!="") and ($_REQUEST['school']=="")){
$sql = "select  * from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.disable_type='$_REQUEST[disable_type]' and spacial_student_disabled.school_code=student_main_main.school_code";
}
else{
$sql = "select  * from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.school_code=student_main_main.school_code";
}
$dbquery = mysqli_query($connect,$sql);
$num_rows=mysqli_num_rows($dbquery);
$totalpages=ceil($num_rows/$pagelen);
...
if(($_REQUEST['disable_type']!="") and ($_REQUEST['school']!="")){
$sql = "select  *,spacial_student_disabled.id from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.disable_type='$_REQUEST[disable_type]' and spacial_student_disabled.school_code='$_REQUEST[school]' and spacial_student_disabled.school_code=student_main_main.school_code order by student_main_main.classlevel ,student_main_main.classroom, student_main_main.student_id limit $start,$pagelen";
}
else if(($_REQUEST['disable_type']=="") and ($_REQUEST['school']!="")){
$sql = "select  *,spacial_student_disabled.id from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.school_code='$_REQUEST[school]' and spacial_student_disabled.school_code=student_main_main.school_code order by student_main_main.classlevel ,student_main_main.classroom, student_main_main.student_id limit $start,$pagelen";
}
else if(($_REQUEST['disable_type']!="") and ($_REQUEST['school']=="")){
$sql = "select  *,spacial_student_disabled.id from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.disable_type='$_REQUEST[disable_type]' and spacial_student_disabled.school_code=student_main_main.school_code order by student_main_main.classlevel ,student_main_main.classroom, student_main_main.student_id limit $start,$pagelen";
}
else{
$sql = "select  *,spacial_student_disabled.id from  spacial_student_disabled left join student_main_main on spacial_student_disabled.person_id=student_main_main.person_id where  student_main_main.ed_year='$year_active_result[ed_year]' and spacial_student_disabled.school_code=student_main_main.school_code order by student_main_main.classlevel ,student_main_main.classroom, student_main_main.student_id limit $start,$pagelen";
}
$dbquery = mysqli_query($connect,$sql);
...
echo "<td><a href=?option=spacial_student&task=student_sch_disable_report2&index=5&id=$result[id]&disable_type=$_REQUEST[disable_type]&page=$page&school=$_REQUEST[school]><img src=images/b_browse.png border='0' ></a></td>";
echo "<Td align='center'>";

$sql2 = "select  id from  spacial_student_help1 where person_id='$result[person_id]'";
$dbquery2 = mysqli_query($connect,$sql2);
if($result2 = mysqli_fetch_array($dbquery2)){
echo "<a href=?option=spacial_student&task=student_sch_disable_report2&index=9&id=$result[id]&disable_type=$_REQUEST[disable_type]&page2=$page&school=$_REQUEST[school]><img src=images/b_browse.png border='0'></a>";
}
...
function goto_index(val){
	if(val==1){
		callfrm("?option=spacial_student&task=student_sch_disable_report2&index=1");   // page ย้อนกลับ
		}
	if(val==2){
		callfrm("?option=spacial_student&task=student_sch_disable_report2");   // page ย้อนกลับ
		}
}
