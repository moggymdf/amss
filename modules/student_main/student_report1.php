...
echo "<tr align='center'><td><font color='#006666' size='3'><strong>รายชื่อนักเรียน ปีการศึกษา  $year_active_result[ed_year]</strong></font></td></tr>";
echo "</table>";
...
$url_link="option=student_main&task=student_report1&year_index=$_REQUEST[year_index]&school_index=$_REQUEST[school_index]&class_index=$_REQUEST[class_index]";  // 2_กำหนดลิงค์ฺ
...
echo  "<table width=90% border='0' align='center'>";
echo "<Tr bgcolor=#FFCCCC align='center' ><Td width='50'>ที่</Td><Td width='90'>เลขประจำตัว<br>นักเรียน</Td><Td width='120'>เลขประจำตัว<br>ประชาชน</Td><Td align='center'>ชื่อ</Td><Td width='70'>เพศ</Td><Td width='70'>ชั้น</Td><Td width='50'>ห้อง</Td><Td width='200'>โรงเรียน</Td></Tr>";
