...
echo "<ul id='nav' class='dropdown dropdown-horizontal'>";
	...
	echo "<li><a href='?option=work' class='dir'>รายงาน</a>";
		echo "<ul>";
			echo "<li><a href='?option=work&task=report_3'>สรุปการปฏิบัติราชการรายวัน3333</a></li>";
			echo "<li><a href='?option=work&task=report_4'>สรุปการปฏิบัติราชการรอบเดือน4444</a></li>";
		echo "</ul>";
	echo "</li>";
	}
	echo "</li>";
